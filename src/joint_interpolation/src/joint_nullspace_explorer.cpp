...
// Start Nullspace Exploration which returns the best arm configuration with highest manipulability
moveit::core::RobotState NullspaceExplorationNode::explore(moveit::core::RobotState& current_state)
{
    ...
    // Return the new state of the robot with the highest manipulability index after nullspace exploration
